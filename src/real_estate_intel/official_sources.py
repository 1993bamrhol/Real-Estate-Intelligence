    ...
    rows = [
        {
            ...
            "source_ar": "الهيئة العامة للعقار - بيانات الإيجار المفتوحة",
            "confidence_ar": "عال",
        ...
        {
            "indicator_ar": "Property Score / درجة العقار",
            "source_ar": "مؤشر مشتق من REGA",
            "confidence_ar": "متوسط",
            "method_ar": "معادلة مرجحة تجمع السيولة (40%)، النمو (35%)، وجاذبية السعر (25%)",
            "decision_use_ar": "اتخاذ قرار أولي بترتيب الفرص وتحديد أولويات الدراسة",
        ...
        {
            "indicator_ar": "النمو السكاني (تقديري)",
            "source_ar": "الهيئة العامة للإحصاء (GASTAT)",
            "confidence_ar": "متوسط (يحتاج ربط جغرافي)",
            "method_ar": "مقارنة أعداد السكان في المدينة أو المنطقة عبر السنوات المتاحة",
            "decision_use_ar": "تحديد الأسواق التي يزداد فيها الطلب الأساسي على السكن",
            "limitation_ar": "بيانات السكان قد لا تكون متاحة على مستوى الحي بدقة، لذلك تستخدم كإشارة على مستوى المدينة.",
        },
        {
